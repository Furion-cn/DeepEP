...
class Buffer:
    ...
    def get_dispatch_config(num_ranks: int) -> Config:
        ...
        config_map = {
            ...
            48: Config(Buffer.num_sms, 8, 288, 32, 128),
            64: Config(Buffer.num_sms, 20, 288, 28, 128),
            80: Config(Buffer.num_sms, 20, 320, 28, 128),
            96: Config(Buffer.num_sms, 20, 288, 28, 128),
    ...
    def get_combine_config(num_ranks: int) -> Config:
        ...
        config_map = {
            ...
            48: Config(Buffer.num_sms, 1, 288, 20, 128),
            64: Config(Buffer.num_sms, 1, 288, 20, 128),
            80: Config(Buffer.num_sms, 1, 320, 20, 128),
            96: Config(Buffer.num_sms, 1, 288, 20, 128),
